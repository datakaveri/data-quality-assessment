...
outputParamFV = {
    "FormatAdherence":{
        ...
        "description": "The metric is rated on a scale between 0 & 1; Computes the ratio of attributes that adhere to the format defined in the data schema."
        },
    "AdditionalFieldsAbsent":{
        "value": str(unknown_fields_absent_metric),
        "type": "number",    
        "metricLabel": "Unknown Fields Absent Metric",
        "metricMessage": "For this dataset, " + str(unknown_fields_absent_metric) + " is the unknown attributes absent metric.",
        "description": "The metric is rated on a scale between 0 & 1; Computes the ratio of unknown attributes to required attributes."
        },
    "AttributeCompleteness":{
        ...
        "description": "The metric is rated on a scale between 0 & 1; Computes the ratio of attributes present to required attributes."
        }
}
